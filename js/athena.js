...
$('#btnRandName').onclick=()=>{if(state.race){state.name=choice([
      ...
      'Voss','Naerys','Dhalan','Rivena','Zorek','Ylena','Kasra','Orian','Thalos','Lirae',
      'Nox','Vaelis','Ryna','Kelaris','Jora','Syra','Talos','Rivka','Aelor','Zai',
      'Kess','Draven','Corin','Maela','Zylen','Ysera','Fayra','Hale','Varyn','Alira',
      'Jarek','Saera','Neris','Corva','Torrin','Reka','Zae','Marris','Serin','Rova',
      'Kaelis','Narek','Syl','Vara','Olen','Nirae','Tessra','Valen','Astrae','Riven Sol']);$('#nameInput').value=state.name;}};
